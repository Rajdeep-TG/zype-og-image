...
// Example URL: http://localhost:3000?title=Hello%20mein%20Name%20ist%20Florian!&url=https://phiilu.com/hello-world
const Post = () => {
        ...
        <div className="flex justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex flex-col gap">
              <p className="font-bold mb-1 text-3xl text-gray-200 font-source-sans-pro">
                Zype
              </p>
              <p className="text-3xl font-semibold text-gray-200 font-source-sans-pro">
                Rajdeep Malakar
              </p>
              <p className="text-2xl font-semibold tracking-wide text-indigo-400 font-open-sans">
                Zype.cf<span className="path">{linkURL.pathname}</span>
              </p>
              <p
